...
- (void)drawRect:(CGRect)rect {
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.bounds)-0.5, CGRectGetWidth(self.bounds), 0.5)];
    lineView.backgroundColor = [UIColor colorWithHex:0xc9c9c9];
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorLocation == HMSegmentedControlSelectionIndicatorLocationDown) {
        indicatorYOffset = self.bounds.size.height - self.selectionIndicatorHeight + self.selectionIndicatorEdgeInsets.bottom-0.5;
    }
