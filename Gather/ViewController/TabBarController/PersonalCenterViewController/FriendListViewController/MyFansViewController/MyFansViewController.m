...
- (void)requestInfo {
    ...
    [Network getListWithType:FriendTypeMyFans uid:self.userId cityId:[Common getCurrentCityId] page:self.currentPage size:kSize uccess:^(FriendListEntity *entity) {
